A \emph{linear recurrence sequence} of order $k$ is a sequence $(u_{n})_{n \in \Naturals}$ with the property that there exist coefficients $\alpha_{1}, \ldots, \alpha_{k}$ such that, for all $n \geq k$,
\begin{equation*}
