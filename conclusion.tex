...
%% such as Baker's theorem \cite{BW93}. Moreover, we could use Baker's
%% theorem in order to characterise, up to dimension $4$, the set of
%% nonterminating points as a convex, closed, semi-algebraic set,
%% partially solving the \textbf{EXPSPACE}-hard problem raised by
%% Ben-Amram in \cite{BGM12}.
...
%% While the \textbf{NP}-hardness of this problem suggests that
%% termination over the integers is intrinsically harder, the gap between
%% this lower bound and our \textbf{EXPSPACE} upper bound is far from
%% satisfactory.
...
%% points in a given convex semi-algebraic set is \textbf{EXPSPACE}-hard,
